...
// 使用本地 reflow 以支持本地 BufferLine
import '../reflow.dart';
import 'package:xterm/src/core/state.dart';
import 'package:xterm/src/utils/circular_buffer.dart';

// 使用我们的 termux wcwidth 替代 xterm 的 unicodeV11.wcwidth
...
class Buffer {
  ...
  void writeChar(int codePoint) {
    ...
    // 核心修改：使用 termuxWcwidth 替代 unicodeV11.wcwidth
    final cellWidth = termuxWcwidth(codePoint);
