...
/// 修改版 Terminal - 使用自定义 wcwidth (Termux 兼容)
///
/// 与原版 xterm Terminal 的唯一区别是使用本地修改的 Buffer，
/// 而 Buffer 使用 termuxWcwidth 来计算字符宽度。
class TermuxTerminal with Observable implements TerminalState, EscapeHandler {
  ...
  @override
  String toString() {
    return 'TermuxTerminal(#$hashCode, $_viewWidth x $_viewHeight, ${_buffer.height} lines)';
  }
